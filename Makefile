...
.PHONY: test-claude test-gemini test-codex test-all-features
...
.PHONY: test-codex-default test-codex-cross-platform test-codex-edge-cases
.PHONY: test-codex-integration test-codex-security test-codex-performance test-codex-regression

# Default target
help:
	@echo "Available targets:"
	@echo "  test         - Run basic feature tests for all features"
	@echo "  test-local   - Test locally with Ubuntu base image"
	@echo "  test-scenarios - Test all defined scenarios"
	@echo "  test-all     - Run all tests for all features"
	@echo "  test-claude  - Run all tests for claude-code-config"
	@echo "  test-gemini  - Run all tests for gemini-cli"
	@echo "  test-codex   - Run all tests for codex-cli"
	@echo "  test-all-features - Run all tests for all features"
	@echo "  copy-features - Copy features to .devcontainer/features"
	@echo "  clean        - Clean up test artifacts"
	@echo "  help         - Show this help message"

# Basic test target - run all features
test:
	@echo "Running basic DevContainer feature tests for all features..."
	...
	devcontainer features test -f codex-cli --skip-autogenerated
...
test-all-features: test-claude test-gemini test-codex
	@echo "All feature tests completed!"

# Test locally with specific image
test-local:
	@echo "Testing locally with Ubuntu base image..."
	devcontainer features test -f claude-code-config -i mcr.microsoft.com/devcontainers/base:ubuntu --skip-autogenerated
	devcontainer features test -f gemini-cli -i mcr.microsoft.com/devcontainers/base:ubuntu --skip-autogenerated
	devcontainer features test -f codex-cli -i mcr.microsoft.com/devcontainers/base:ubuntu --skip-autogenerated
...
test-ubuntu:
	...
	devcontainer features test -f codex-cli -i mcr.microsoft.com/devcontainers/base:ubuntu .
...
test-debian:
	...
	devcontainer features test -f codex-cli -i mcr.microsoft.com/devcontainers/base:debian .
...
test-alpine:
	...
	devcontainer features test -f codex-cli -i mcr.microsoft.com/devcontainers/base:alpine .
...
copy-features:
	...
	cp -r src/codex-cli .devcontainer/features/
...
validate:
	...
	@echo "Validating codex-cli..."
	@if [ ! -f "src/codex-cli/devcontainer-feature.json" ]; then \
		echo "ERROR: codex-cli/devcontainer-feature.json not found"; \
		exit 1; \
	fi
	@if [ ! -f "src/codex-cli/install.sh" ]; then \
		echo "ERROR: codex-cli/install.sh not found"; \
		exit 1; \
	fi
	@if [ ! -x "src/codex-cli/install.sh" ]; then \
		echo "ERROR: codex-cli/install.sh is not executable"; \
		exit 1; \
	fi
...
debug:
	...
	devcontainer features test -f codex-cli --verbose .
...
# Individual extended tests for all features
test-performance:
...
# Codex-specific test targets
test-codex-default:
	@echo "Running codex-cli default tests..."
	devcontainer features test -f codex-cli -t test_default .

test-codex-cross-platform:
	@echo "Running codex-cli cross-platform tests..."
	devcontainer features test -f codex-cli -t test_cross_platform .

test-codex-edge-cases:
	@echo "Running codex-cli edge cases tests..."
	devcontainer features test -f codex-cli -t test_edge_cases .

test-codex-integration:
	@echo "Running codex-cli integration tests..."
	devcontainer features test -f codex-cli -t test_integration .

test-codex-security:
	@echo "Running codex-cli security tests..."
	devcontainer features test -f codex-cli -t test_security .

test-codex-performance:
	@echo "Running codex-cli performance tests..."
	devcontainer features test -f codex-cli -t test_performance .

test-codex-regression:
	@echo "Running codex-cli regression tests..."
	devcontainer features test -f codex-cli -t test_regression .
